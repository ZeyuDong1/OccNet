...
class BEVFormer(MVXTwoStageDetector):
    ...
    def extract_img_feat(self, img, img_metas, len_queue=None):
        """Extract features of images.
            return a list of features from different layer of FPN
           if len_queue:
             [data with shape (bs, len_queue, num_cams, C, Hi, Wi), ... ]
           else:
             [data with shape (bs, num_cams, C, Hi, Wi), ... ]
    ...
    def forward_train(self,
        ...
        if self.keep_bev_history:
            ...
            if self.use_occ_gts:  # both occ and gt box are loaded
