...
model = dict(
    ...
    img_neck=dict(
        ...
        num_outs=_num_levels_,   # can be decreased to save memory for cross-attention
...
train_pipeline = [
    ...
    dict(type='CustomDefaultFormatBundle3D', class_names=class_names),  # use custom
