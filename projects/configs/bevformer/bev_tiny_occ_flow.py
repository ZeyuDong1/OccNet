...
only_occ=False # 无det但是有flow和occ
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        loss_flow=dict(type='L1Loss', loss_weight=0.25),  # occupancy flow
        loss_occupancy=dict(
            type='FocalLoss',
            use_sigmoid=True,
            gamma=2.0,
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='TensorboardLoggerHook'),
                dict(type='WandbLoggerHook', init_kwargs=dict(project='Occ_Cluster',name="det+occ+flow-id3")),
...
# resume_from  = "/nfs/projects/OccNet-1/work_dirs/bev_tiny_occ_flow/latest.pth"
load_from  = "/nfs/projects/OccNet-1/work_dirs/bev_tiny_occ_flow/latest.pth"
